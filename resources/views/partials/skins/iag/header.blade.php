        ...
        <div class="fflch-firstsecondthird">
            ...
            <div class="fflch-first">
                <div class="fflch-item">
                    ...
                    <img class="fflch-logo-img" src="{{ asset('/vendor/laravel-usp-theme/skins/iag/images/logo_iag.png') }}">
                    </a>
                </div>
            </div>
            ...
            <div class="fflch-second">       
                <div class="fflch-item">
                    <div class="fflch-slogan">
                        <a class="fflch-slogan-link"  href="{{ config('app.url')}}">{{ config('laravel-usp-theme.slogan','Instituto de Astronomia, Geofísica e Ciências Atmosféricas') }} </a>
                    </div>
